...
export const BotChatDialog = ({ open, onOpenChange, botName, apiKey }: BotChatDialogProps) => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Atualizar conversation_id se for a primeira mensagem
